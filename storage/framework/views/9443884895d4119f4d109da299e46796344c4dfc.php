...
<head>
    ...
    <!-- Title -->
    <title>Animo &amp; News</title>

    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(url('assets/portal_berita/img/core-img/favicon.ico')); ?>">

    <!-- Stylesheet -->

    <link rel="stylesheet" href="<?php echo e(url('assets/portal_berita/style.css')); ?>">
</head>
<body>
	<!-- Preloader -->
        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <a href="<?php echo e(url('dashboard')); ?>" class="nav-brand"><img src="<?php echo e(url('assets/portal_berita/img/core-img/logo.png')); ?>" alt=""></a>
                    ...
                    <div class="nav-content d-flex align-items-center">
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li class="active"><a href="<?php echo e(url('dashboard')); ?>">Home</a></li>
                        ...
                        <div class="top-meta-data d-flex align-items-center">
                            ...
                            <div class="top-search-area">
                                <form action="<?php echo e(url('dashboard')); ?>" method="post">
    ...
    <div class="hero-area owl-carousel">
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url('<?php echo e(url('assets/portal_berita/img/bg-img/1.jpg')); ?>');">
        ...
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url('<?php echo e(url('assets/portal_berita/img/bg-img/2.jpg')); ?>');">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Post Contetnt -->
        ...
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url('<?php echo e(url('assets/portal_berita/img/bg-img/3.jpg')); ?>');">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <!-- Post Contetnt -->
    ...
    <section class="mag-posts-area d-flex flex-wrap">
        ...
        <div class="post-sidebar-area left-sidebar mt-30 mb-30 bg-white box-shadow">
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/4.jpg')); ?>" alt="">
                    </div>
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/5.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/6.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/7.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/8.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
            ...
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="<?php echo e(url('assets/portal_berita/img/bg-img/add.pn')); ?>g" alt=""></a>
            </div>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/9.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/10.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">Choose The Perfect Accommodations</a>
                        <div class="post-meta d-flex justify-content-between">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/11.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/12.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
                ...
                <div class="single-blog-post d-flex">
                    <div class="post-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/13.jpg')); ?>" alt="">
                    </div>
                    <div class="post-content">
            ...
            <div class="trending-now-posts mb-30">
                ...
                <div class="trending-post-slides owl-carousel">
                    ...
                    <div class="single-trending-post">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/19.jpg')); ?>" alt="">
                        <div class="post-content">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/20.jpg')); ?>" alt="">
                        <div class="post-content">
                    ...
                    <!-- Single Trending Post -->
                    <div class="single-trending-post">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/21.jpg')); ?>" alt="">
                        <div class="post-content">
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="single-featured-post">
                                ...
                                <div class="post-thumbnail mb-50">
                                    <img src="<?php echo e(url('assets/portal_berita/img/bg-img/22.jpg')); ?>" alt="">
                            ...
                            <div class="featured-video-posts-slide owl-carousel">
                                ...
                                <div class="single--slide">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/23.jpg')); ?>" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/24.jpg')); ?>" alt="">
                                        </div>
                                        <div class="post-content">
                                            <a href="single-post.html" class="post-title">A Guide To Rocky Mountain Vacations</a>
                                            <div class="post-meta d-flex">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/25.jpg')); ?>" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/26.jpg')); ?>" alt="">
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="single-blog-post d-flex style-3">
                                        <div class="post-thumbnail">
                                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/27.jpg')); ?>" alt="">
                                        </div>
                                        <div class="post-content">
            ...
            <div class="most-viewed-videos mb-30">
                ...
                <div class="most-viewed-videos-slide owl-carousel">
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/28.jpg')); ?>" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/29.jpg')); ?>" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            <span class="video-duration">09:27</span>
                        </div>
                        <div class="post-content">
                    ...
                    <div class="single-blog-post style-4">
                        <div class="post-thumbnail">
                            <img src="<?php echo e(url('assets/portal_berita/img/bg-img/30.jpg')); ?>" alt="">
                            <a href="video-post.html" class="video-play"><i class="fa fa-play"></i></a>
                            <span class="video-duration">09:27</span>
                        </div>
                        <div class="post-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="<?php echo e(url('assets/portal_berita/img/bg-img/31.jpg')); ?>" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="<?php echo e(url('assets/portal_berita/img/bg-img/32.jpg')); ?>" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="<?php echo e(url('assets/portal_berita/img/bg-img/33.jpg')); ?>" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="single-blog-post d-flex style-3 mb-30">
                            <div class="post-thumbnail">
                                <img src="<?php echo e(url('assets/portal_berita/img/bg-img/34.jpg')); ?>" alt="">
                            </div>
                            <div class="post-content">
                                <a href="single-post.html" class="post-title">From Wetlands To Canals And Dams Amsterdam Is Alive</a>
                                <div class="post-meta d-flex">
        ...
        <div class="post-sidebar-area right-sidebar mt-30 mb-30 box-shadow">
            ...
            <!-- Sidebar Widget -->
            <div class="single-sidebar-widget">
                <a href="#" class="add-img"><img src="<?php echo e(url('assets/portal_berita/img/bg-img/add2.p')); ?>ng" alt=""></a>
            </div>
            ...
            <div class="single-sidebar-widget p-30">
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/14.jpg')); ?>" alt="">
                    </div>
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/15.jpg')); ?>" alt="">
                    </div>
                    <div class="youtube-channel-content">
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/16.jpg')); ?>" alt="">
                    </div>
                    <div class="youtube-channel-content">
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/17.jpg')); ?>" alt="">
                    </div>
                    <div class="youtube-channel-content">
                ...
                <div class="single-youtube-channel d-flex">
                    <div class="youtube-channel-thumbnail">
                        <img src="<?php echo e(url('assets/portal_berita/img/bg-img/18.jpg')); ?>" alt="">
                    </div>
                    <div class="youtube-channel-content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="footer-widget">
                        <!-- Logo -->
                        <a href="<?php echo e(url('dashboard')); ?>" class="foo-logo"><img src="<?php echo e(url('assets/portal_berita/img/core-img/logo')); ?>2.png" alt=""></a>
	...
	<!-- ##### Footer Area End ##### -->
<!-- <?php echo e(url('assets/portal_berita/js/jquery/jquery-2.2.4.min.js')); ?> -->
	<!-- ##### All Javascript Script ##### -->
	<!-- jQuery-2.2.4 js -->
	<script src="<?php echo e(url('assets/portal_berita/js/jquery/jquery-2.2.4.min.js')); ?>"></script>
	<!-- Popper js -->

	<script src="<?php echo e(url('assets/portal_berita/js/bootstrap/popper.min.js')); ?>"></script>
	<!-- Bootstrap js -->
	<script src="<?php echo e(url('assets/portal_berita/js/bootstrap/bootstrap.min.js')); ?>"></script>
	<!-- All Plugins js -->
	<script src="<?php echo e(url('assets/portal_berita/js/plugins/plugins.js')); ?>"></script>
	<!-- Active js -->
	<script src="<?php echo e(url('assets/portal_berita/js/active.js')); ?>"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\laravel\portal_berita\resources\views/dashboard.blade.php ENDPATH**/ ?>